...
4. Run `node build-post-index.mjs` to regenerate `posts/index.json` with rendered HTML.
...
4. If you are deploying the site manually, upload the updated `posts/` folder, `posts/index.json`, and the site files.
